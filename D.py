...
# Mostrar banner en rojo
print(Colorate.Diagonal(Colors.red, Center.XCenter(banner)))

# Mostrar info en blanco plano (sin gradiente)
print(Colorate.Horizontal(Colors.static("white"), Center.XCenter(info)))

# Mostrar comandos en blanco plano también
def show_prompt():
    print(Colorate.Horizontal(Colors.static("white"), Center.XCenter(methods_text)))
...
def main():
    while True:
        # Prompt con "Hyper" rojo y "•C2 >>" blanco
